...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-aws-c2s.html["Erste Schritte in der AWS C2S Umgebung"^]
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-ha-azure.html["Erfahren Sie mehr über HA-Paare in Azure"^].
